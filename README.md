# Carlos Ortiz - Senior Frontend & Full-Stack Developer

## 👋 Hello, I'm Carlos Ortiz
...
- **Full-stack Next.js** application with TypeScript editor & real-time test execution
- **PostgreSQL** + **Drizzle ORM** for user progress & challenge data
- **Sandpack** for in-browser React component rendering
- **Secure testing server** with isolated code execution
- **Tailwind CSS** + **shadcn/ui** responsive interface
...
- Built custom **WordPress plugins** for AI assistant integration
- Developed with **Rete.js** for visual workflow editing
...
- **Led frontend architecture** for multiple AI-powered products
- **Built scalable design systems** adopted across organizations
- **Successfully launched** a full-stack SaaS platform (ReactChallenges.com)
- **10+ years** of progressive experience from freelancing to lead engineering roles
- **Extensive WordPress expertise** with modern development practices

## 🎯 Currently Focused On

- Enhancing **ReactChallenges.com** with more challenge types and community features
- **AI integration patterns** for practical business applications
- **Performance optimization** and developer experience improvements
- **Open-source contributions** to React and frontend ecosystem
